...
export async function GET(
    ...
    try {
        ...
        if(!brandId) return NextResponse.json({ msg:'Brand id is required', status:400});
        ...
        return NextResponse.json({ msg:`Error in brand GET req ${error}`,status:500});
    }
}
...
export async function PATCH(
    ...
    return NextResponse.json({ msg:`Error in brand PATCH req ${error}`, status:500})
...
try {
    ...
    return NextResponse.json({ msg:`Error in brand DELETE req ${error}`,status:500});
}
